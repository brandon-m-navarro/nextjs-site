      ...
      <div>
        ...
        <div className="fixed top-8 left-8 right-8 bottom-8 md:top-16 md:left-16 md:right-16 md:bottom-16 bg-white dark:bg-[#2d3748] rounded-xl shadow-2xl z-50 flex flex-col sm:flex-row overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden p-6">
            ...
            {/* Tags */}
            <div className="flex flex-wrap gap-2 wrap-break-word mb-6 sm:flex hidden">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 box-border bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-sm rounded-full"
                >
                  {tag}
                </span>
              ))}
